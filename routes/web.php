...
Route::prefix('backoffice')->namespace('BackOffice')->middleware(['auth','backoffice'])->group(function(){
    ...
    Route::post('/promo/store','PromoController@store')->name('backoffice.promo.store');
...
Route::prefix('frontoffice')->namespace('FrontOffice')->middleware(['auth','frontoffice'])->group(function(){
    ...
    // subscription
    Route::get('subscription/contract','SubscriptionController@contract')->middleware('hassubscription')->name('frontoffice.subscription.contract');

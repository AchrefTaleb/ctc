...
require('./plugins/assets/table/datatable/datatables');
require('./plugins/assets/font-icons/feather/feather.min');
require('./plugins/assets/table/datatable/button-ext/dataTables.buttons');
...
jQuery(document).ready(function() {
    ...
    jQuery('#staff-table').DataTable({
        ...
        "oLanguage": {
            ...
            "sZeroRecords": "Tableau est vide",
            "sInfoEmpty": "Tableau est vide",
            "sInfoFiltered": ""
        },
        "stripeClasses": [],

                        ...
                        <div class="col-md-8 ">
                            <form class="form-inline float-right" method="POST" action="{{ route('backoffice.categorymail.create') }}" novalidate>
                                ...
                                <div class="form-group mr-2">
                                    <label class="mr-2">Ajouter nouveau catégorie</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror " name="name" placeholder="nom de catéforie" required>

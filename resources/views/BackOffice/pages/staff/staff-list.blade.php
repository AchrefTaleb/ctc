                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 inline">
                            <h4 class="float-left">Liste des membres du staff</h4>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Supprimer {{ $staff->name.' '.$staff->last_name }}</h5>
                                </div>
                                <div class="modal-body">
                                    <p class="modal-text">Voulez-vous vraiment supprimer ce membre du staff ? </p>
                                </div>

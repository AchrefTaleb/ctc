            ...
            <div class="statbox widget box box-shadow">
                ...
                <table id="staff-table" class="multi-table table table-striped style-3 table-bordered table-hover non-hover" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td> {{ dd($client->subscription) }}@if($client->status) <span class="shadow-none badge badge-primary">Active</span> @else <span class="shadow-none badge badge-danger">Suspendu</span> @endif</td>

<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#settings" data-toggle="collapse"  @if( (Route::currentRouteName() == 'backoffice.promo.list')||(Route::currentRouteName() == 'backoffice.promo.create') ) aria-expanded="true" data-active="true"   @else aria-expanded="false" data-active="false"  @endif class="dropdown-toggle">
                    <div class="">

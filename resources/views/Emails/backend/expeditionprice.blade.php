...
Nous vous informons que le coût pour votre demande de réexpédition n° {{ $request->id }} à été calculé par notre équipe pour un montant de {{ $request->price }} € au meilleur tarif en vigueur.
